...
<footer>
    <div class="clearfix footer" id="footer">
        <div class="foo-promise container">
            <ul class="clearfix">
                <li class="foo-promise-zheng">
                    <a  href="#"><i class="icon-foo"></i>99元全场包邮</a>
                </li>
                <li class="foo-promise-bao">
                    <a   href="#"><i class="icon-foo"></i>7天无理由退货</a>
                </li>
                <li class="foo-promise-15">
                    <a href="#"><i class="icon-foo"></i>15天退货保障</a>
                </li>
                <li class="foo-promise-30">
                    <a   href="#"><i class="icon-foo"></i>30天换货保障</a>
                </li>
                <li class="foo-promise-branches">
                    <a href="#"><i class="icon-foo"></i>424家售后服务网点</a>
                </li>
            </ul>
        </div>
        <div class="container clearfix">
            ...
            <div class="foo-service-contact">
                <p class="s-tel">
                    ...
                    <span class="s-time">服务时段：7 x 24 仅收市话费</span>
                </p>
                <p class="qq-webchat"><a href="javascript:;" id="foo-service-chat" title="在线客服">24小时在线客服</a></p>
            </div>
